...
const DAYS = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    sections:[
      ...
      { id:"soir", items:[
        {s:"opt",  t:"Soirée libre : Kitashinchi ou Dotonbori", sub:"KITASHINCHI (北新地) : Quartier de bars premium — verre de whisky japonais pour terminer la soirée.\n\nDOTONBORI : Ambiance néons et street food nocturne — takoyaki, okonomiyaki, kushikatsu. Retour à pied vers l'hôtel possible."},
...
const CHECKLIST = [
  ...
  { cat:"🔴 Urgence absolue — Réserver maintenant", color:"var(--danger)", items:[
    ...
    { name:"Kittan Hibiki — Wagyu Yakiniku Osaka", date:"9 mai — 13h00 (déjeuner)", platform:"Tablecheck.com", status:"ok", note:"✅ Réservation confirmée (3 adultes)" },
    ...
    items: [
      {
        ...
        prix:"A3 : ¥3000-5000/pers. A5 : ¥8000-15000/pers", ou:"Kittan Hibiki Osaka (J13, 9 mai 13h — réservation confirmée).",
